...
const COMMUNITY_CHANNELS = [
  {
    ...
    descriptionDe: "Tausche dich in den Kommentaren unserer Videos mit über 13.000 Khao Lak Fans aus und verpasse keinen Vlog.",
    descriptionEn: "Join more than 13,000 Khao Lak fans in the comments on our videos and never miss a vlog.",
    buttonTextDe: "Kanal besuchen",
    buttonTextEn: "Visit channel",
  ...
  },
  {
    ...
    descriptionDe: "Folge unseren täglichen Eindrücken, Live-Updates und Storys direkt aus Thailand.",
    descriptionEn: "Follow our daily impressions, live updates and stories directly from Thailand.",
    buttonTextDe: "Folgen",
    buttonTextEn: "Follow",
  ...
  {
    titleDe: "Insider Forum (bald verfügbar)",
    titleEn: "Insider Forum (coming soon)",
    descriptionDe: "Hier entsteht ein exklusiver Ort für deine Fragen: Hotels, Routenplanung und die besten lokalen Guides im direkten Austausch.",
    descriptionEn: "An exclusive place for your questions about hotels, route planning and the best local guides is coming soon.",
    buttonTextDe: "Bald verfügbar",
    buttonTextEn: "Coming soon",
    url: "#",
    icon: "🏛️",
...
export default async function CommunityPage() {
  ...
  const copy = language === "en"
    ? {
        badge: "Together, not alone",
        headingStart: "Become part of the",
        description: "Share your experiences, ask like-minded travellers questions and plan your trip together with fellow insiders.",
        discordTitle: "Exclusive Discord server",
        discordDescription: "Your direct connection to real experts. Skip the endless online search and get precise answers backed by genuine insider knowledge.",
        features: [
          "Lightning-fast answers to your questions",
          "Connect directly with other travellers",
          "Current live updates and local insider tips",
          "An exclusive community with Melo & Marc",
        ],
        access: "Access for only",
        perMonth: "/ month",
        cancellable: "Cancel at any time",
        join: "Join the server now",
        promise: "Our promise",
        guidelines: "Wherever we connect, respectful, friendly and helpful conversation matters to us. Spam and disrespectful posts are removed immediately.",
      }
    : {
        badge: "Zusammen statt allein",
        headingStart: "Werde Teil der",
        description: "Teile deine Erfahrungen, stelle Fragen an Gleichgesinnte und plane deine Reise gemeinsam mit vielen Insidern.",
        discordTitle: "Exklusiver Discord Server",
        discordDescription: "Dein direkter Draht zu den absoluten Experten. Überspringe die lange Suche im Netz und erhalte punktgenaue Antworten mit echtem Insider-Wissen.",
        features: [
          "Blitzschnelle Antworten auf deine Fragen",
          "Direkter Austausch mit anderen Urlaubern",
          "Aktuelle Live-Updates & Geheimtipps vor Ort",
          "Exklusive Community von und mit Melo & Marc",
        ],
        access: "Zugang für nur",
        perMonth: "/ Mon.",
        cancellable: "Jederzeit kündbar",
        join: "Jetzt Server beitreten",
        promise: "Unser Versprechen",
        guidelines: "Egal wo wir uns austauschen: Wir legen Wert auf einen respektvollen, freundlichen und hilfsbereiten Umgang. Spammer und unhöfliche Beiträge fliegen sofort raus.",
      };
  return (
    <main className="min-h-screen bg-slate-50/40 pb-24">
      ...
      <section className="container mx-auto px-6 max-w-5xl mt-12 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            <div className="lg:col-span-8 space-y-4">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-sm text-slate-200 font-semibold">
                <li className="flex items-center gap-2">
                  <span className="text-teal-400 text-lg">⚡</span> {copy.features[0]}
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-teal-400 text-lg">🌴</span> {copy.features[1]}
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-teal-400 text-lg">📍</span> {copy.features[2]}
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-teal-400 text-lg">💎</span> {copy.features[3]}
                </li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-4 bg-white/5 border border-white/10 rounded-2xl p-6 text-center space-y-4 shadow-2xl backdrop-blur-sm">
              <div className="space-y-0.5">
                <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">{copy.access}</span>
                <div className="text-3xl font-black text-white">
                  {language === "en" ? "€2.00" : "2,00 €"} <span className="text-sm font-medium text-slate-400">{copy.perMonth}</span>
                </div>
                <span className="text-[11px] text-teal-400 font-bold block">{copy.cancellable}</span>
              </div>
              <a
            ...
            >
              <div className="space-y-3">
                ...
                <h2 className="text-lg font-black text-slate-900 leading-tight">
                  {"titleEn" in channel
                    ? (language === "en" ? channel.titleEn : channel.titleDe)
                    : channel.title}
                </h2>
                <p className="text-slate-400 text-xs font-medium leading-relaxed">
                  {language === "en" ? channel.descriptionEn : channel.descriptionDe}
                </p>
              </div>
              ...
              <div className="pt-4 mt-6 border-t border-slate-50">
                {channel.disabled ? (
                  <span className="inline-flex w-full justify-center items-center px-4 py-2.5 rounded-full text-xs font-bold bg-slate-50 text-slate-400 border border-slate-100 cursor-not-allowed">
                    {language === "en" ? channel.buttonTextEn : channel.buttonTextDe}
                  </span>
                ) : (
                  <a
                    href={channel.url}
        ...
        <div className="bg-teal-50/40 border border-teal-100/50 rounded-2xl p-6 text-center max-w-2xl mx-auto">
          <p className="text-xs font-bold text-teal-700/80 tracking-wide uppercase">🤝 {copy.promise}</p>
