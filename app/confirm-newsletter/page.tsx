    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-teal-50 via-white to-white px-6">
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-gray-100 p-8 text-center">
        ...
        <p className="mt-3 text-gray-600 leading-relaxed">
          {isSuccess
            ? "Perfekt! Du bist jetzt offiziell auf unserer Liste. Wir melden uns bald mit ersten exklusiven Khao Lak Updates."
            : "Der Link ist ungültig oder abgelaufen. Bitte versuche dich erneut anzumelden."}
        </p>
