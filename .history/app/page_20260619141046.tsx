  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      <section className="relative min-h-[820px] overflow-hidden bg-[url('/images/hero.png')] bg-cover bg-center">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-8 pt-14 md:grid-cols-[1.05fr_0.95fr]">
          <div className="max-w-3xl text-white">
            ...
            <div className="mt-10 flex flex-wrap gap-8 text-sm text-white/90">
              <div className="font-semibold text-yellow-300">★★★★★ <span className="text-white">4,9 Bewertung</span></div>
              ...
              <div className="relative h-[660px] w-[330px] rounded-[3.5rem] border-[11px] border-slate-950 bg-white p-5 shadow-[0_30px_80px_rgba(0,0,0,0.45)]">
                ...
                <div className="mt-11">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex h-8 w-8 items-center justify-center rounded-full border text-teal-600">i</div>
                  </div>
      ...
      <section className="relative z-20 mx-auto -mt-16 grid max-w-7xl grid-cols-2 gap-6 px-8 pb-20 md:grid-cols-6">
        {features.map(([icon, title, text]) => (
          <div key={title} className="rounded-3xl bg-white p-6 text-center shadow-xl shadow-slate-200/80 transition hover:-translate-y-1 hover:shadow-2xl">
