...
const categories = [
  ...
  ["Natur", "Dschungel, Wasserfälle und Nationalparks", "/images/wasserfall.png"],
...
export default function Home() {
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-8 py-20 md:grid-cols-[0.8fr_1.2fr]">
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          {categories.map(([title, text, image]) => (
            <div
              key={title}
              className="group relative h-72 overflow-hidden rounded-3xl shadow-xl"
            >
              <div
