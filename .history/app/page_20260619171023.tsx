...
export default function Home() {
  ...
  <div className="mx-auto flex max-w-7xl items-start justify-between px-8 pt-3 text-white">
    <Image
      src="/images/logo.png"
    ...
    <div className="mt-8 hidden gap-10 text-sm font-semibold md:flex">
      <a href="#">Entdecken</a>
      <a href="#">Planen</a>
      <a href="#">Erleben</a>
      <a href="#">Favoriten</a>
    ...
    <button className="mt-5 rounded-full bg-teal-500 px-7 py-3.5 text-sm font-bold shadow-xl shadow-teal-950/30 transition hover:bg-teal-400">
      Zur Warteliste
    </button>
  </div>
</nav>
