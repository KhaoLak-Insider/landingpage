...
const features = [
  ["📍", "Interaktive Karte", "Alle Orte auf einer Karte mit Offline-Zugriff"],
  ["🗓️", "Reise planen", "Plane deinen perfekten Tag mit unserem Planer"],
  ["♡", "Favoriten", "Speichere deine Lieblingsorte und teile sie mit Freunden"],
  ["★", "Geheimtipps", "Handverlesene Empfehlungen abseits der Touristenpfade"],
  ["🎒", "Packliste", "Nie wieder etwas vergessen mit unserer Packliste"],
