...
<section className="bg-teal-500 py-24 text-white">
  <div className="mx-auto max-w-4xl px-8 text-center">
    ...
    <p className="mx-auto mt-6 max-w-2xl text-lg text-white/90">
      Trage dich jetzt unverbindlich in die Warteliste ein und erfahre als
      Erste:r, wenn die Khao Lak Insider App startet.
    </p>
    ...
    <div className="mx-auto mt-10 flex max-w-xl flex-col gap-4 sm:flex-row">
      <input
        ...
        className="h-14 flex-1 rounded-full px-6 text-slate-900 outline-none"
      />

      <button className="h-14 rounded-full bg-slate-950 px-8 font-bold text-white transition hover:bg-slate-800">
        Zur Warteliste
      </button>
    </div>
