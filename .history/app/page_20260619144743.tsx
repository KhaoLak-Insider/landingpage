...
const appScreens = [
  ["🗺️", "Interaktive Karte", "Finde Strände, Märkte, Tempel und Restaurants direkt auf der Karte."],
  ["🗓️", "Reiseplaner", "Plane deinen perfekten Urlaubstag mit Favoriten und Empfehlungen."],
  ["📍", "Spot-Details", "Alle wichtigen Infos zu Orten, Entfernung, Dauer und Highlights."],
  ["♡", "Favoriten", "Speichere deine Lieblingsorte und rufe sie jederzeit wieder auf."],
];

export default function Home() {
  return (
    <main className="min-h-screen bg-white text-slate-900">
      <section className="relative min-h-[860px] overflow-hidden bg-[url('/images/hero.png')] bg-cover bg-center">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-8 pt-8 md:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="hidden justify-end md:flex">
            <div className="relative">
              ...
              <div className="relative h-[720px] w-[330px] rounded-[3.5rem] border-[11px] border-slate-950 bg-white p-5 shadow-[0_30px_80px_rgba(0,0,0,0.45)]">
        ...
        >
          <path
            ...
            d="
              M0,58
              C260,50 430,48 650,56
              C850,64 1030,72 1230,62
              C1320,58 1390,54 1440,58
              L1440,90
              L0,90
              Z
            "
      ...
      <section className="mx-auto grid max-w-7xl items-center gap-12 px-8 py-20 md:grid-cols-[0.7fr_1.3fr]">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {appScreens.map(([icon, title, text]) => (
            <div
              key={title}
              className="rounded-[2.5rem] border-[8px] border-slate-950 bg-white p-5 shadow-2xl"
            >
              <div className="mx-auto mb-4 h-5 w-20 rounded-full bg-slate-950" />
        ...
        <div className="grid gap-8 text-center md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-3 text-slate-600">
              Orte, Strände, Restaurants und Geheimtipps.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-3 text-slate-600">
              Start der Khao Lak Insider App.
            </p>
          </div>
        </div>
      </section>
